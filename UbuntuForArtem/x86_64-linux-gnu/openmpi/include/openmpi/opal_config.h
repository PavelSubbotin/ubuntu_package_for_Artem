...
#define MCA_hwloc_external_shmem_header "/usr/include/hwloc/shmem.h"

/* Complete set of command line arguments given to ROMIOs configure script */
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -g -O2 -fdebug-prefix-map=/build/openmpi=. -fstack-protector-strong -Wformat -Werror=format-security -O3 -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-Wdate-time -D_FORTIFY_SOURCE=2   ' FFLAGS='-g -O2 -fdebug-prefix-map=/build/openmpi=. -fstack-protector-strong' LDFLAGS='-Wl,-Bsymbolic-functions -Wl,-z,relro   ' --enable-shared --disable-static  --prefix=/usr --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_PROC_ENDPOINT_TAG_MAX 2
